...
//			people = productProp.adaptPeople[0].people;
			$('#city').fillselect('productMgr-getPropMsg.htm', {
				'dataMap': {'value': 'propId', 'text': 'name'}, 
		        'params': {'selectKey': province}
		    });
			$('#smallcatalog').fillselect('productMgr-getPropMsg.htm', {
				'dataMap': {'value': 'propId', 'text': 'name'}, 
		        'params': {'selectKey': big}
		    });
		}
		$('#province').fillselect('productMgr-getPropMsg.htm', {
			'dataMap': {'value': 'propId', 'text': 'name'}, 
	        'preValue': -1,
	        'preText': '选择省份',
		...
		$('#province').chainselect('#city', 'productMgr-getPropMsg.htm', {
            'dataMap': {'value': 'propId', 'text': 'name'}, 
            'preValue': -1,
            'preText': '选择城市',
            'defaultValue': city || -1
        });
		$('#bigcatalog').fillselect('productMgr-getPropMsg.htm', {
			'dataMap': {'value': 'propId', 'text': 'name'}, 
	        'preValue': -1,
	        'preText': '选择大分类',
		...
		$('#bigcatalog').chainselect('#smallcatalog', 'productMgr-getPropMsg.htm', {
            'dataMap': {'value': 'propId', 'text': 'name'}, 
            'preValue': -1,
            'preText': '选择小分类',
