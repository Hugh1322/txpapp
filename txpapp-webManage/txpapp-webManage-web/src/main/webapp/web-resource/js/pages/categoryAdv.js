...
var clickAddOrEdit=function(id,actionUrl){
	...
	var html = '';
	$.ajax({
		url: actionUrl,// + "/admin/adv/categoryAdv_toEditDetail.htm",
		type:"POST",
		data:{'adv.advertisementId':id},
		dataType:"html",
		async: false,
...
function checkAdv(formId){
	var re=false;
	$.ajax({
		type: 'POST',
		async:false,
		url:_ctxPath+'/admin/adv/categoryAdv_checkAdv.htm',
