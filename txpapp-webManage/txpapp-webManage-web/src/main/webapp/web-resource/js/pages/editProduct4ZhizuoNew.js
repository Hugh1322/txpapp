...
$(document).ready(function(){
	...
	$("#save").click(function(){
		...
		$("#productRebate").formValidator({onFocus:"商品返点介于0-100范围内"}).inputValidator({type:"number",min:0,max:100,empty:{leftEmpty:false,rightEmpty:false,emptyError:"两边不能有空格"},onError:"商品返点介于0-100范围内"});
...
function createRepertoriesTable(){
	...
	if($sizes.length == 0){
		...
		var strList = "<td><input type='text' class='repertories-num weight' maxlength='6' name='product.productSkus[0].productSkuOptionValues[1].overrideSkuOptionValue' onchange='checkWeight(this)'/></td>"
					+ "<td><input type='text' class='repertories-num inventory' maxlength='5' name='product.productSkus[0].inventory' onchange='checkInventory(this)'/></td>"
					+ "<td><input type='text' class='repertories-num repertories-width skuCode' maxlength='30' name='product.productSkus[0].sellerSkuCode' onblur='checkSkuCode(this,0)'/></td>"
					...
					+ "<td class='isHidden'><input type='text' class='repertories-num makePrice' maxlength='11' name='product.productSkus[0].makePrice' onchange='checkUnitPrice(this)'/></td>"
					+ "<td class='isHidden'><input type='text' class='repertories-num logisticsPrice' maxlength='11' name='product.productSkus[0].logisticsPrice' onchange='checkUnitPrice(this)'/></td>"
					+ "<td class='isHidden'><input type='text' class='repertories-num postPrice' maxlength='11' name='product.productSkus[0].postPrice' onchange='checkUnitPrice(this)'/></td>";
	...
	//仅勾选了尺寸时
		...
		$.each($sizes, function(i,size){
			...
			var strList = "<td><input type='text' class='repertories-num weight' maxlength='6' name='product.productSkus["+index+"].productSkuOptionValues[1].overrideSkuOptionValue' onchange='checkWeight(this)'/></td>"
				...
				+ "<td><input type='text' class='repertories-num repertories-width skuCode' maxlength='30' name='product.productSkus["+index+"].sellerSkuCode' onblur='checkSkuCode(this,"+index+")'/></td>"
				...
				+ "<td class='isHidden'><input type='text' class='repertories-num makePrice' maxlength='11' name='product.productSkus["+index+"].makePrice' onchange='checkUnitPrice(this)'/></td>"
				+ "<td class='isHidden'><input type='text' class='repertories-num logisticsPrice' maxlength='11' name='product.productSkus["+index+"].logisticsPrice' onchange='checkUnitPrice(this)'/></td>"
				+ "<td class='isHidden'><input type='text' class='repertories-num postPrice' maxlength='11' name='product.productSkus["+index+"].postPrice' onchange='checkUnitPrice(this)'/></td>";
			$tr_productSku.find('input[type=radio]').attr("name","product.productSkus[0].isDefault");
			if(index == 0){
				$tr_productSku.find('input[type=radio]').attr("checked","true");
...
//			$input_internationalCode.val(obj.internationalCode);
	...
	var leng = $(".repertories").find("tr:gt(0)").length;
	if(leng>1){
		$.each($(".repertories").find("tr:gt(0)"), function(i,tr){
			var $tr = $(tr);
...
function returnway(value){
	if(1 == value){
		document.getElementById("productRebate").disabled=false;
	}else{
		document.getElementById("productRebate").disabled=true;
	}
}