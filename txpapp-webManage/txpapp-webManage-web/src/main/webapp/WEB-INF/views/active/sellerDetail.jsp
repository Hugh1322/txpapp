...
<script type="text/javascript">
	var returnButton=function(){
		window.location.href="${_ctxPath}/admin/user/user-executeActiveApply.htm";
	}
</script>
</head>
<body>
...
<div class="body m-w980p">
	<div class="addBusiness-border">
		...
		<form id="form1" action="${_ctxPath}/admin/active/active-executeActiveApply.htm" method="post">
		<input type="hidden" name="allActiveApplyPage.params.activeId" id="activeId" value="${allActiveApplyPage.params.activeId}" />
		<input type="hidden" name="allActiveApplyPage.params.productName" id="activeId" value="${allActiveApplyPage.params.productName}" />
		<input type="hidden" name="allActiveApplyPage.params.status" id="activeId" value="${allActiveApplyPage.params.status}" />
		<input type="hidden" name="allActiveApplyPage.params.sellerId" id="activeId" value="${allActiveApplyPage.params.sellerId}" />
...
<!-- 			</tr> -->
			...
			<tr>
				...
				<input type="submit" value="返回" class="addBusiness-btn"/>
				</td>
			</tr>
		</table>
		</form>
