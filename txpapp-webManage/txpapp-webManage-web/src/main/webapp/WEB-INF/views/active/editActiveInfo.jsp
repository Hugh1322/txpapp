...
<jsp:include page="../include/header.jsp"  flush="true" />
	<div class="body m-w980p">
			<h1 class="add-title">活动发布</h1>
			<form action="${_ctxPath}/admin/active/active-saveActiveInfo.htm" method="post" id="form1">
					<table border="0" class="add-table">
						...
						<tr>
							...
							<td width="500"><input type="text" name="activeInfo.beginDate" value="${activeInfo.beginDate}" class="Wdate" id="startTime"
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" /><label>至:</label> <input type="text"
								name="activeInfo.endDate" value="${activeInfo.endDate}" class="Wdate" id="endTime"
						...
						<tr>
							...
							<td><input type="text" name="activeInfo.applyDate" value="${activeInfo.applyDate}" class="Wdate" id="applyTime"
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" /></td>
					...
					<table border="0" class="add-table" style="width:750px">
						<tr>
