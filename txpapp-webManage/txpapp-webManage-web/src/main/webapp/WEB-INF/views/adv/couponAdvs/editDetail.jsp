...
<body>
	...
	<div class="body m-w980p">
		<form action="${_ctxPath}/admin/adv/couponAdv_saveDetail.htm"
			method="post" id="advForm" style="height:800px">
			<div class="m-mt10p addBanner" id="coupon">
				<jsp:include page="detailContent.jsp" />
				<div class="addADV cf">
					<label>&nbsp;</label>
					<div class="infoADV">
						<input type="button" id="submitForm" onclick="addDetailAdvs('advForm')"
