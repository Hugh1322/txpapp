...
<body>
	...
	<div class="body m-w980p">
		<!--start form-->
		<form class="m-mt10p m-clear" action="${_ctxPath}/admin/order/order-searchOrders4CashManager.htm" method="post" id="subform">
            <input type="hidden" id="sellerId" name="orderPage.params.sellerId" value="${orderPage.params.sellerId}" />
          	<input type="hidden" id="beginTime" name="orderPage.params.beginOverProductTime" value="${orderPage.params.beginOverProductTime}" />
			<input type="hidden" id="endTime" name="orderPage.params.endOverProductTime" value="${orderPage.params.endOverProductTime}" /> 
			<input type="hidden" name="orderPage.params.cashType" value="${orderPage.params.cashType}" />
            <div  class="m-clear">
                <span class="m-fl">
                	订单结算状态：
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#export").bind("click", function() {
			...
			$("#subform").attr("action","${_ctxPath}/admin/order/order-exportManagerCashOrders.htm");
			$("#subform").submit();
