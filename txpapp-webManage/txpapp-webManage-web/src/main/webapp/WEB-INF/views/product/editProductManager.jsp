...
<div class="body m-w980p">
	<form id="addForm" method="post" target="_blank">
		...
		<table border="0" class="addPro-table">
			...
			<tr>
				<td class="left-td">*商品别名：</td>
				<td colspan="2"><input type="text" data-default="商品名称+规格，如：酸奶500ml" class="pro-name" name="product.aliasName" value="${product.aliasName}" id="aliasName"/></td>
			...
			<tr>
				...
				<td colspan="2"><input type="text" data-default="QS证的有效日期" readonly="readOnly" class="Wdate" value="<fmt:formatDate value='${product.expiryDate}' pattern='yyyy-MM-dd'/>" name="product.expiryDate" id="expiryDate"></td>
...
<!--end footer-->
<script type="text/javascript">
	var STATUS_DRAFT = <%= Product.STATUS_CHECK_PEND%>;
...
// 	}
	...
	$("#aliasName").formValidator({onFocus:"商品别名为1-16个字符组成"}).inputValidator({min:1,max:16,empty:{leftEmpty:false,rightEmpty:false,emptyError:"两边不能有空格"},onError:"商品别名为1-16个字符组成"}).regexValidator({ regExp: "^[\u4E00-\u9FA5A-Za-z0-9_]+$", onError: "商品别名为1-16个字符组成" });
