	...
	<form id="addForm" method="post" target="_blank">
		...
		<%--	<tr>
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="pro-name" name="product.aliasName" value="${product.aliasName }" id="aliasName"/></td>
...
<script type="text/javascript" src="${_jsPath }/pages/editProduct4ZhizuoOnline.js"></script>
<!--end footer-->
<script type="text/javascript">
