...
import com.txp.app.dto.test.ActivityProduct;
import com.txp.app.entity.Page;
import com.txp.app.supplier.service.TestCheckServiceApi;
import com.txp.app.supplier.service.TestServiceApi;
...
import com.txp.app.util.StringUtil;
...
public class TestController {
	...
	@Autowired
	private TestCheckServiceApi testCheckServiceApi;

	public void test() {
		log.info("test.start");
		try {
			testCheckServiceApi.check(1l);
		}catch (Exception e) {
			e.printStackTrace();
			log.error("error " +e,e);
		}
	...
	@ResponseBody
	@RequestMapping(value = "test55.do")
	public String test55(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
			throws Exception {
		test();
...
//	private ApiSupplierService apiSupplierService;
	...
	@RequestMapping(value = "product2/quickEditProduct.do")
	public String quickEditProduct(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
			throws Exception {
		return "product/quickEditProduct";
	}

	@ResponseBody
	@RequestMapping(value = "product2/quickSave.do")
	public String quickSave(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
			 {
		String json = "{\"info\":true,\"msg\":\"start！\"}";
		return json;
	}

	@RequestMapping(value = "product2/importProduct.do")
	public String importProduct(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		log.info("importProduct .. start");
		return "redirect:/system/user/findUserByCriteriaAndPage.do";
	}

	@ResponseBody
	@RequestMapping(value = "product2/confirmSample1.do")
	public String confirmSample1(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		String json = "{\"info\":true,\"msg\":\"start！\"}";
		return json;
	}

	@RequestMapping(value = "product2/exportProductsByConditions.do")
	public String exportProductsByConditions(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		log.info("exportProductsByConditions .. start");
		return "redirect:/system/user/findUserByCriteriaAndPage.do";
	}

	@RequestMapping(value = "product2/view.do")
	public String view(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		try {
			log.info("view .. start");
			modelMap.put("mark",request.getParameter("mark"));

		}catch (Exception e) {
			log.error("view error:"+e,e);
		}
		return "test/viewProduct";
	}

	@RequestMapping(value = "product2/review.do")
	public String review(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		try {
	...
	@RequestMapping(value = "product2/toUpload.do")
	...
	@ResponseBody
	@RequestMapping(value = "product2/saveReviewResult.do")
	public String saveReviewResult(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		String json = "{\"code\":true,\"info\":\"start！\"}";
		return json;
	}

	@RequestMapping(value = "upload/load.do")
	public String load(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap)
	{
		log.info("load .. start");
		return "test/upload";
	}
	...
	@RequestMapping(value = "market/{name}.do")
	public String market(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
						 @PathVariable("name") String name,BasePagination<ActivityProduct> activityProduct)
			throws Exception {
		...
		activityProduct.setParams(params);

		modelMap.put("activityProduct",activityProduct);
		modelMap.put("marketactPage",activityProduct);
		return "market/"+name;
	}
