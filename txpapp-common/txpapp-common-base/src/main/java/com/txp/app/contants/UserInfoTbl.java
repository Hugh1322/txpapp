...
public class UserInfoTbl {
	...
	@ExcelField(filedName="支付宝实名认证名" ,sort=8)
	protected String alipayName;          //注册支付宝姓名
	@ExcelField(filedName="开户银行" ,sort=9)
	protected String bankName;             //开户银行
	@ExcelField(filedName="银行账号" ,sort=10)
	protected String bankAccount;          //开户银行账户
	
	protected String bankAccountName;		//银行开户名
...
//	private List<Product> productList;
	...
	protected String foreighName;	//国外名称
	protected String logo;			//logo
	protected String description;	//商家摘要
	...
	public String getForeighName() {
		return foreighName;
	}
	public void setForeighName(String foreighName) {
		this.foreighName = foreighName;
	}
